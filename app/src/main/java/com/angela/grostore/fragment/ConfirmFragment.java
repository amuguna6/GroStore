...
import com.angela.grostore.activity.CartActivity;
import com.angela.grostore.MainActivity;
import com.angela.grostore.adapter.CheckoutCartAdapter;
import com.angela.grostore.model.Cart;
...
public class ConfirmFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        shipping = view.findViewById(R.id.delivery_amount);
    ...
    private void closeProgress() {
        ...
        Order order = new Order(id, orderNo, currentDateandTime, "Kshs. " + _totalAmount, "Pending");
        orderList.add(order);
